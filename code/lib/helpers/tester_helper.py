...
class Tester(object):
    ...
    def save_results(self, results, output_dir='./outputs'):
        ...
        # output_dir = os.path.join('/mnt/disk/KITTIOdometry_Full/KITTI_FLAT/test/output/test_semantic_trans')
        # output_dir = os.path.join('/mnt/disk/KITTIOdometry_Full/KITTI_FLAT/test/output/test_semantic_trans_2DFFN')
        output_dir = os.path.join('/mnt/disk/KITTIOdometry_Full/KITTI_FLAT/test/output/test_ablation')
